...
| [0003](0003-catalog-facts-only-keyed-by-card-one-json-file.md) | The catalog holds Scryfall facts only, keyed by card with printings nested, in one JSON file under the collection-file convention | Accepted |
